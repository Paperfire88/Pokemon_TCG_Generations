...
.PortraitPals:
	...
	db PALETTE_MINT_PORTRAIT
	db PALETTE_BERNARD_PORTRAIT   ; PORTRAIT_BERNARD
	db PALETTE_MELISSA_PORTRAIT   ; PORTRAIT_MELISSA
	db PALETTE_YUTA_PORTRAIT   	  ; PORTRAIT_YUTA
	db PALETTE_LIZ_PORTRAIT   	  ; PORTRAIT_LIZ
	db PALETTE_PARKER_PORTRAIT    ; PORTRAIT_PARKER
	db PALETTE_CASSIE_PORTRAIT    ; PORTRAIT_CASSIE
	db PALETTE_CHIP_PORTRAIT      ; PORTRAIT_CHIP
	db PALETTE_CATHERINE_PORTRAIT ; PORTRAIT_CATHERINE
	db PALETTE_JACOB_PORTRAIT     ; PORTRAIT_JACOB
	db PALETTE_CODY_PORTRAIT      ; PORTRAIT_CODY
...
.NPCSpriteAnimData
	...
	db SPRITE_OW_BERNARD,   SPRITE_ANIM_RED_NPC_UP      ; $2d
