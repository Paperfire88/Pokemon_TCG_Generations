...
BoosterTypes:
	...
	db BOOSTER_LABORATORY ; BOOSTER_LABORATORY_FIGHTING
	db BOOSTER_LABORATORY ; BOOSTER_LABORATORY_LIGHTNING
	db BOOSTER_MYSTERY    ; BOOSTER_MYSTERY_PSYCHIC	
	db BOOSTER_COLOSSEUM  ; BOOSTER_COLOSSEUM_DARKNESS
	db BOOSTER_EVOLUTION  ; BOOSTER_EVOLUTION_DARKNESS
	db BOOSTER_MYSTERY    ; BOOSTER_MYSTERY_DARKNESS	
	db BOOSTER_LABORATORY ; BOOSTER_LABORATORY_DARKNESS
	db BOOSTER_LOST_ISLE  ; BOOSTER_LOST_ISLE_NEUTRAL
...
BoosterScenesAndNameTexts:
	...
	db SCENE_ISLE_BOOSTER, SCENE_ISLE_BOOSTER 
	tx IsleBoosterText
