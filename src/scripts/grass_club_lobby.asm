...
.ows_e656
	...
	take_card APPLIN
	give_card APPLETUN
	show_card_received_screen APPLETUN
...
.ows_e67f
	jump_if_card_owned TSAREENA, .ows_e686
	print_text_quit_fully Text06f7

.ows_e686
	jump_if_card_in_collection TSAREENA, .ows_e68d
...
.ows_e68d
	...
	take_card TSAREENA
	give_card CELEBI
	show_card_received_screen CELEBI
	print_text_quit_fully Text06f3
...
.ows_e6b6
	jump_if_card_owned EMBOAR, .ows_e6bd
	print_text_quit_fully Text06fe

.ows_e6bd
	jump_if_card_in_collection EMBOAR, .ows_e6c4
