...
Script_BeatKen:
	...
	give_card CHANDELURE
    show_card_received_screen CHANDELURE
.give_booster_packs
	give_booster_packs BOOSTER_EVOLUTION_FIRE, BOOSTER_MYSTERY_FIRE, BOOSTER_LABORATORY_FIRE, NO_BOOSTER
