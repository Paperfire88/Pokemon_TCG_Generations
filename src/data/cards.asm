...
SteeneeCard:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw ExpandEffectCommands ; effect commands
	db NONE ; flags 1
	db NULLIFY_OR_WEAKEN_ATTACK ; flags 2
	db NONE ; flags 3
	db 0
...
TsareenaCard:
	...
	db 42 ; level
	dw 5, 7 ; weakness value (+/-)
	dw 34 * 10 ; resistance value (+/-)
...
TrevenantCard:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw DarkForestEffectCommands ; effect commands
	db NONE ; flags 1
	db NULLIFY_OR_WEAKEN_ATTACK ; flags 2
	db NONE ; flags 3
	db 0
...
RillaboomCard:
	...
	db 50 ; damage
	db DAMAGE_NORMAL ; category
	dw Acid50PercentEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
BudewCard:
	...
	tx StrangeEvolutionRoseliaDescription ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db COSTLESS ; category
	dw StrangeEvolutionBudewEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	; attack 2
	energy COLORLESS, 1 ; energies
	tx ItchyPollenName ; name
	tx ItchyPollenDescription ; description
	dw NONE ; description (cont)
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw ItchyPollenEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	dw 2, 4 ; weakness value (+/-)
	dw 9 * 10 ; resistance value (+/-)
	tx BudewDescription ; description
	db 16
...
RoseliaCard:
	...
	; attack 1
	energy GRASS, 1 ; energies
	tx SweetSpikeName ; name
	tx SweetSpikeDescription ; description
	dw NONE ; description (cont)
	db 10 ; damage
	db DAMAGE_NORMAL ; category
...
CentiskorchCard:
	...
	db DAMAGE_TO_OPPONENT_BENCH|ATTACHED_ENERGY_BOOST ; flags 1
	db DISCARD_ENERGY ; flags 2
	db NONE ; flags 3
	db 3
	db ATK_ANIM_BIG_FLAME ; animation
...
CameruptCard:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw MagmaRecycleEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
ChandelureCard:
	...
	db ATTACHED_ENERGY_BOOST ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 6
	db ATK_ANIM_FIRE_SPIN ; animation
...
MagmarLv24Card:
	...
	tx MagmaPunchDescription ; description
	dw NONE ; description (cont)
	db 20 ; damage
	db DAMAGE_PLUS ; category
	dw MagmaPunchEffectCommands ; effect commands
	db INFLICT_BURN ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
MagmortarCard:
	...
	; attack 2
	energy FIRE, 2, COLORLESS, 1 ; energies
	tx FlameBazookaName ; name
	tx FlameBazookaDecription ; description
	dw NONE ; description (cont)
	db 40 ; damage
	db DAMAGE_X ; category
	dw FlameBazookaEffectCommands ; effect commands
	db DAMAGE_TO_OPPONENT_BENCH ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 30
...
ShelgonCard:
	...
	tx ProtectChargeDescription ; description
	dw NONE ; description (cont)
	db 20 ; damage
	db RESIDUAL ; category
	dw ProtectChargeEffectCommands ; effect commands
	db NONE ; flags 1
	db NULLIFY_OR_WEAKEN_ATTACK ; flags 2
	db NONE ; flags 3
	db 0
...
SalamenceCard:
	...
	; attack 2
	energy FIRE, 1, COLORLESS, 1 ; energies
	tx CrimsonFireName ; name
	tx CrimsonFireDescription ; description
	dw NONE ; description (cont)
	db 40 ; damage
	db DAMAGE_PLUS ; category
	dw BurningFireEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 10
...
GreninjaCard:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw WaterCallEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
AraquanidCard:
	...
	db 30 ; damage
	db DAMAGE_PLUS ; category
	dw LiquidationEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
ChewtleCard:
	...
	db 25 ; level
	dw 8, 2 ; weakness value (+/-)
	dw 485 * 10 ; resistance value (+/-)
...
WattrelCard:
	...
	energy COLORLESS, 1 ; energies
	tx ChargeName ; name
	tx ChargeDescription ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db RESIDUAL ; category
	dw ChargeEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 1
...
KilowattrelCard:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw ShortCircuitEffectCommands ; effect commands
	db DAMAGE_TO_OPPONENT_BENCH_F ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	; attack 2
	energy LIGHTNING, 1, COLORLESS, 1 ; energies
	tx StormBoltName ; name
	tx StormBoltDescription ; description
	dw NONE ; description (cont)
	db 30 ; damage
	db DAMAGE_NORMAL ; category
	dw StormBoltEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	db 42 ; level
	dw 6, 11 ; weakness value (+/-)
	dw 1014 * 10 ; resistance value (+/-)
...
ElectabuzzLv35Card:
	...
	; attack 2
	energy LIGHTNING, 1, COLORLESS, 1 ; energies
	tx PlasmaPunchName ; name
	tx PlasmaPunchDescription ; description
	dw NONE ; description (cont)
	db 20 ; damage
	db DAMAGE_PLUS ; category
	dw PlasmaPunchEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
FlygonCard:
	...
	db 20 ; damage
	db DAMAGE_PLUS ; category
	dw DustyPillarEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
