...
DustoxCard:
	...
	db 40 ; damage
	db DAMAGE_NORMAL ; category
	dw YANMEGAVenomPowderEffectCommands ; effect commands
...
ScytherCard:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw TestEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING ; flags 3
	db 0
...
PupitarCard:
	...
	tx ExplosiveEvolutionDescription2 ; description (cont)
	db 0 ; damage
	db RESIDUAL ; category
...
GardevoirCard:
	...
	db 10 ; damage
	db DAMAGE_X ; category
	dw EnergyBurstfectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
DusknoirCard:
	...
	tx ShadowBindName ; name
	tx ShadowBindDescription ; description
	dw NONE ; description (cont)
	db 50 ; damage
	db DAMAGE_NORMAL ; category
	dw ShadowBindEffectCommands ; effect commands
	db DAMAGE_TO_OPPONENT_BENCH ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 10
...
MunnaCard:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw LongDistanceHypnosisEffectCommands ; effect commands
	db INFLICT_SLEEP ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
ShiinoticCard:
	...
	; attack 1
	energy 0 ; energies
	tx IlluminateName ; name
	tx IlluminateDescription ; description
	tx PKMNPowerCondition ; description (cont)
	db 0 ; damage
	db POKEMON_POWER ; category
