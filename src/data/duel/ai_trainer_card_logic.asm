...
AITrainerCardLogic:
	...
	ai_trainer_card_logic AI_TRAINER_CARD_PHASE_07, GUST_OF_WIND,           AIDecide_BossOrders,                     AIPlay_BossOrders
	ai_trainer_card_logic AI_TRAINER_CARD_PHASE_10, GUST_OF_WIND,           AIDecide_BossOrders,                     AIPlay_BossOrders
