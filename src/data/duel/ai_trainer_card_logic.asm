...
AITrainerCardLogic:
	ai_trainer_card_logic AI_TRAINER_CARD_PHASE_03, POTION,                 AIDecide_Potion1,                        AIPlay_Potion
	...
	ai_trainer_card_logic AI_TRAINER_CARD_PHASE_03, RARE_CANDY,        AIDecide_RareCandy,                 AIPlay_RareCandy	
	...
	ai_trainer_card_logic AI_TRAINER_CARD_PHASE_01, ENERGY_SEARCH,          AIDecide_EnergySearch,                   AIPlay_EnergySearch
	...
	ai_trainer_card_logic AI_TRAINER_CARD_PHASE_13, MARNIE,                   AIDecide_Lass,                           AIPlay_Lass
	...
	ai_trainer_card_logic AI_TRAINER_CARD_PHASE_02, HEAVY_BALL,              AIDecide_Heavyball,                       AIPlay_EnergyRetrieval
