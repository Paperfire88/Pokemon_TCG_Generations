...
; constants to use as input to LookForCardInDeck
	...
	const SEARCHEFFECT_GRASS
	const SEARCHEFFECT_GRASSENERGY
	const SEARCHEFFECT_FIRE
	const SEARCHEFFECT_FIREENERGY
	const SEARCHEFFECT_WATER
	const SEARCHEFFECT_WATERENERGY
	const SEARCHEFFECT_LIGHTNING
	const SEARCHEFFECT_LIGHTNINGENERGY
	const SEARCHEFFECT_FIGHTING
	const SEARCHEFFECT_FIGHTINGENERGY
	const SEARCHEFFECT_PSYCHIC
	const SEARCHEFFECT_PSYCHICENERGY
	const SEARCHEFFECT_DARKNESS
	const SEARCHEFFECT_DARKNESSENERGY
