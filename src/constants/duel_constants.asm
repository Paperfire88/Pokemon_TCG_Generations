...
DEF SUBSTATUS1_INCREASE_BY_30          EQU $17
DEF SUBSTATUS1_NO_DAMAGE_BENCH         EQU $18
DEF SUBSTATUS1_SWITCHED_IN			   EQU $20
...
DEF SUBSTATUS3_NO_POKEPOWERS_F           EQU 2
DEF SUBSTATUS3_NO_WEAKNESS_F             EQU 3

; DUELVARS_ARENA_CARD_FLAGS constants
DEF SOMETHINGFORNOW_F			EQU 3
DEF HEALED_THIS_TURN_F			EQU 4
...
DEF HEALED_THIS_TURN			EQU 1 << HEALED_THIS_TURN_F
DEF SOMETHINGFORNOW				EQU 1 << SOMETHINGFORNOW_F
...
; constants for PracticeDuelActionTable entries
	...
	const PRACTICEDUEL_PLAY_BASCULIN
	const PRACTICEDUEL_PUT_DEWPIDER_IN_BENCH
	...
	const PRACTICEDUEL_PLAY_DEWPIDER_FROM_BENCH
...
; constants to use as input to LookForCardInDeck
	...
	const SEARCHEFFECT_SUPPORTER	  ; $85
	const SEARCHEFFECT_FIRE			  ; $86
	const SEARCHEFFECT_WATER
	const SEARCHEFFECT_LIGHTNING
	const SEARCHEFFECT_FIGHTING
	const SEARCHEFFECT_PSYCHIC
	const SEARCHEFFECT_DARKNESS
	const SEARCHEFFECT_COLORLESS
	const SEARCHEFFECT_EVOLUTION
	const SEARCHEFFECT_HITMON
	const SEARCHEFFECT_SUBS

; challenge constants
	DEF LC_CHALLENGE  EQU 0