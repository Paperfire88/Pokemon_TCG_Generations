...
DEF NUM_CARDS_COLOSSEUM   EQU 80
DEF NUM_CARDS_EVOLUTION   EQU 80
DEF NUM_CARDS_MYSTERY     EQU 80
DEF NUM_CARDS_LABORATORY  EQU 80
DEF NUM_CARDS_ISLE     	  EQU 60
DEF NUM_CARDS_PROMOTIONAL EQU 13
