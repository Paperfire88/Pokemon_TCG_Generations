...
DEF NUM_BOOSTER_CARD_TYPES EQU const_value
	...
	const BOOSTER_MYSTERY_FIRE             	  ; $1d
	const BOOSTER_LABORATORY_FIRE         	  ; $1e
	const BOOSTER_LABORATORY_FIGHTING         ; $1f
	const BOOSTER_LABORATORY_LIGHTNING        ; $20
	const BOOSTER_MYSTERY_PSYCHIC        	  ; $21
	const BOOSTER_COLOSSEUM_DARKNESS		  ; $22
	const BOOSTER_EVOLUTION_DARKNESS		  ; $23
	const BOOSTER_MYSTERY_DARKNESS		      ; $24
	const BOOSTER_LABORATORY_DARKNESS		  ; $25
	const BOOSTER_LOST_ISLE_NEUTRAL			  ; $26
