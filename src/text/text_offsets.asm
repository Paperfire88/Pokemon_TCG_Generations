...
TextOffsets::
	...
	textpointer FroakiesWithdrawDescription
	...
	textpointer ShadowBindName
	textpointer ShadowBindDescription
	...
	textpointer RequiemName; 0x0cff	
	...
	textpointer	ExplosiveBoltName
	textpointer	ExplosiveBoltDescription
